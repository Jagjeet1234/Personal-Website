...
typewriter
  .pauseFor(1000)
  .typeString('My name is Jagjeet Ram and I am a student hoping to obtain a Bachelors in Computer Science. Coding has for a long time been a very intresting topic that has excited me and I wanted to pursue a career path using this skill. The variety of Computer Science also led me to choose it as my major as there are so many jobs to go into such as cybersecurity or software engeneering.  ') //Add your own tagline
  .pauseFor(100000)
  .start()
